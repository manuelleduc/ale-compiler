...
import dsl.xtext.generator.DslGenerator;
import dsl.xtext.parser.antlr.DslAntlrTokenFileProvider;
import dsl.xtext.parser.antlr.DslParser;
import dsl.xtext.parser.antlr.internal.InternalDslLexer;
import dsl.xtext.scoping.DslScopeProvider;
import dsl.xtext.serializer.DslSemanticSequencer;
import dsl.xtext.serializer.DslSyntacticSequencer;
...
public abstract class AbstractDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "dsl/xtext/Dsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("dsl.xtext.Dsl");
	}
